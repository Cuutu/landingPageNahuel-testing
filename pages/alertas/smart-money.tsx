          ...
          <div className={styles.formSection}>
            ...
            <div className={styles.formGroup}>
              ...
              <textarea
                ...
                placeholder="Breve descripción del análisis de Smart Money"
                rows={3}
                disabled={loading}
              />
            </div>
